# Landscape plus (pitmates' Edition)

[我的博客演示](http://pitmates.github.io/)   
...
```bash
git clone https://github.com/pitmates/landscape-plus.git themes/landscape-plus
```
...
+ `links` - 友情链接
+ `qisqus_shortname` - disqus评论id
+ `baidushare` - 是否开启百度分享

**建议！** `mathjax`、`links`、`disqus_shortname`、`baidushare`配置项也支持放在站点的`_config.yml`中，并且我们建议你这样做。
